...
#endif
#define SUBVERSION					0x2		// ... release ID (i.e. v1.1 for TestChip,  v2.1 for SpiNNaker2, 2.2 for SerialROM with DHCP)
...
#define LED_FLASH_INTERVAL			0x100	// Flash LED every 256ms
...
#define LED_0						(1 << 0)
#define LED_1						(1 << 1)
#define SPINN3_RED_LED					(1 << 5)				// CP DHCP image, 10thNov2011 RED LED different location
#define LED_2						(1 << 6)
#define LED_3						(1 << 7)

#define LEDSSPINN2					(LED_0 | LED_1 | LED_2 | LED_3)		// CP DHCP image, 10thNov2011 Board type SPINN2
#define LEDSSPINN3					(LED_0 | SPINN3_RED_LED)		// CP DHCP image, 10thNov2011 Board type SPINN3
