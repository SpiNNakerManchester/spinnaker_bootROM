...
/* ------------------------------------ CHIP DETAILS -----------------------------------*/
#ifdef SPINNAKER2
#define NUMBER_OF_CORES				18		// number of cores in SpiNNaker2 chip  TODO !!!S2!!! verify
#endif
#ifdef TEST_CHIP
...
#define WATCHDOG_COUNT				0x5F5E100 // If Sysbus running at 80Mhz/100,000,000 = 800ms TODO this is taking much longer than 800ms to reset!!! This needs checking!
...
#define FAILURE_LOG_BASE			(DETECTED_SDRAM_INFO_BASE - (sizeof(int) * NUMBEROFCORES))
...
#define SYSCTRL_SOFT_RESET 			0xf2000018	// CPU soft reset reg //TODO why are these duplicated?
