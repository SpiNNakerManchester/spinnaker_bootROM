...
#define VERSION			0x1	// this is the main stream of library/ROM code
#define SUBVERSION		0x1	//     this is it's releaseID	
...
unsigned int EthLinkUp=0;    // 14thJan - dbugging	
...
unsigned short EthPacketID = 0;			// CP 14thJan used as a packet id (wraps at 65535)
