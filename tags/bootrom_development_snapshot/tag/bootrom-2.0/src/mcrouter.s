...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; setup mc table entry r0=offset, r1=key, r2=mask, r3=mcroute
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
setupMCTable
		STMFD	SP!, {R4-R5, LR}
    	LDR		R4, =RTR_BASE
    	LDR		R5, =RTR_KEY_TABLE  
    	ADD		R5, R5, R0
    	STR		R1,	[R4, R5]
    	LDR		R5, =RTR_MASK_TABLE
    	ADD		R5, R5, R0
    	STR		R2,	[R4, R5]
    	LDR		R5, =RTR_ROUTE_TABLE
    	ADD		R5, R5, R0
    	STR		R3,	[R4, R5]
    	LDMFD	SP!, {R4-R5, PC}
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; setup mc table entry r0=offset, r1=value
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
setupP2PTable
	STMFD	SP!, {R0-R3, LR}
    	LDR		R3, =RTR_BASE
    	LDR		R2, =RTR_P2P_TABLE
    	ADD		R2, R2, R0
    	STR		R1,	[R3, R2]
    	LDMFD	SP!, {R0-R3, PC}
