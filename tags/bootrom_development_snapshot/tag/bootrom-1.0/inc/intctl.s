...
monInit
    	...
    	;setup ethernet
    	;try to read the phy if attached then initialize the ethernet otherwise just ignore
...
testIntCtl
    	...
    	;LDR		R1, [R3]
    	;ORR		R1, R1, #(0x1 << 1)					;status of int ctl at bit 1
    	;STR		R1, [R3]
    	;ORR		R11, R11, #(0x1 << 1)			;status of int ctl at bit 1
outtic	
		MOV		R1,		#0x0
    	STR		R1,		[R2, #VICVECTADDR]
    	STR		R1,		[R2, #VICDEFVECTADDR]
