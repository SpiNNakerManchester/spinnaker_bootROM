...
initCommCtl
		...
		MOV		PC, LR				;LDMFD	SP!, {R4-R7, PC}						;LDMFD	sp!, {r4-r12, pc}
		
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; COMMCTLR setupSourceID, new id in R0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
SetupSourceID
		LDR		R2, =COMMCTLR_BASE
		STRH	R0, [R2, #COMMCTLR_R0]
		MOV		PC, LR				;LDMFD	SP!, {R4, PC}
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; TIMER TEST
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
testCommCtl
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;writePacketASM to be called from void writePacket2(unsigned long r0, unsigned 
;long routingKey, unsigned long payload)
...
; 		TST     R0,  #COMMCTLR_R1_DATA      ;with payload?  					 
;      	STRNE	R2,  [R3, #COMMCTLR_R2]	    ;if yes, writing payload to comm ctlr R2;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;writePacketASM to be called from void writePacketWithPayload(unsigned long r0, unsigned long routingKey, unsigned long payload)
;parameters r0= routingKey
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
sendSpike
 		LDR		R2,	 =COMMCTLR_BASE
 		STR		R0,  [R2, #COMMCTLR_R3]	    ;writing routing key to comm ctlr  R3
		MOV     PC,   LR					;return
