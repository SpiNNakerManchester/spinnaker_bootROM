...
reset	
	IF :DEF: SPINNAKER2	
		...
		TST		r12, #0x80
		;LDRNE	pc, =MANUFACTURING_TESTS ; CP 9thNov2011 : Not required - booting from SerialROM
	ENDIF
...
normal_boot
	IF :DEF: SPINNAKER2
		;GET serial.s 	; CP 9thNov2011 no need for recursive serial code! Already running from Serial ROM
				; need to set other CPUs on their way as they are "boot_wait"ing on MISC_CTRL bit 1
	ENDIF
